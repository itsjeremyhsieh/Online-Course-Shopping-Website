                        ...
                        <div class="tab-content" id="myaccountContent">
                            ...
                            <div class="tab-pane fade show active" id="dashboad" role="tabpanel">
                                <div class="myaccount-content">
                                    ...
                                    <lord-icon src="https://cdn.lordicon.com/rqskgpey.json" trigger="loop"
                                        colors="primary:#121331" scale="30" style="width:100px;height:100px">
                                    </lord-icon>
                                    <b>普通</b>會員,金熙您好
                                    <!------
								<div class="welcome">
                                        ...
                                        <form action="#">
                                            <div class="row">
                                                <div class="col-lg-6 col-12 mb-30">
                                                    <input id="first-name" placeholder="姓名" type="text">
                                                </div>

                                                <div class="col-12 mb-30">
                                                    <input id="display-name" placeholder="使用者名稱" type="text">
                                                </div>

                                                <div class="col-12 mb-30">
                                                    <input id="email" placeholder="電子郵件" type="email">
                                                </div>
                                                ...
                                                <div class="col-12 mb-30">
                                                    <input id="phone" placeholder="手機號碼" type="text">
                                                </div>

                                                <div class="col-12 mb-30">
                                                    <input id="address" placeholder="通訊地址" type="text">
                                                </div>
                                                ...
                                                <div class="col-12 mb-30">
                                                    <input id="current-pwd" placeholder="請輸入目前密碼"
                                                        type="password">
                                                </div>

                                                <div class="col-lg-6 col-12 mb-30">
                                                    <input id="new-pwd" placeholder="請輸入新密碼" type="password">
                                                </div>

                                                <div class="col-lg-6 col-12 mb-30">
                                                    <input id="confirm-pwd" placeholder="請再次輸入新密碼"
                                                        type="password">
                                                </div>
